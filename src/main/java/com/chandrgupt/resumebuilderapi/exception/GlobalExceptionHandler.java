package com.chandrgupt.resumebuilderapi.exception;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handleResourceExistsException(ResourceExistException ex){
    ...
    public ResponseEntity<Map<String , Object>> handleGenricException(Exception ex){
        ...
        response.put("errors", ex.toString());
